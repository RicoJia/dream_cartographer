...
HOST_SIMPLE_ROBOTICS_UTILS_DIR="/home/$USER/file_exchange_port/The-Dream-Robot/src/SimpleRoboticsUtils"
SIMPLE_ROBOTICS_UTILS_DIR=/home/${USER}/dream_cartographer_ws/src/SimpleRoboticsUtils
sudo docker run --name ${IMAGE_NAME}-container --rm -e DISPLAY=$DISPLAY \
    ...
    -v ~/.ssh:/root/.ssh \
    -v ${HOST_SIMPLE_ROBOTICS_UTILS_DIR}:/home/${USER}/dream_cartographer_ws/src/SimpleRoboticsUtils \
    -v ${HOST_SIMPLE_ROBOTICS_UTILS_DIR}/simple_robotics_common_udev_rules:/etc/udev/rules.d \
    -v /dev/bus/usb:/dev/bus/usb \
    -v /home/${USER}/.ros:/home/rico/.ros/ \
    --user $(id -u):$(id -g) -e XAUTHORITY=/root/.Xauthority \
    -e SIMPLE_ROBOTICS_UTILS_DIR=${SIMPLE_ROBOTICS_UTILS_DIR} \
